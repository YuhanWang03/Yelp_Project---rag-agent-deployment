"""
Yelp Business Intelligence Agent — Legacy Gradio Demo

Standalone legacy-page usage:
    python legacy_app.py                                          # Ollama backend (default)
    python legacy_app.py --config configs/deepseek_v4_flash.yaml  # DeepSeek-V4 backend
    python legacy_app.py --share                                  # public Gradio link
